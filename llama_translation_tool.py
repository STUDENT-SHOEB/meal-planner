...
client = Groq(api_key='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')  
...
st.write("Translate text using LLaMA 3.1 and get contextual explanations for language learning by **Aditya, Shoeb, Mansi, Teena**")
