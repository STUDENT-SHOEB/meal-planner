...
client = Groq(api_key='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')  # Replace 'your_api_key' with your Groq API key
...
st.write("Generate personalized recipes and get detailed explanations for meal planning by **Mohd Shoeb**.")
